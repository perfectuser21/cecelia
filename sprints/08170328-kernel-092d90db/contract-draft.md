...
**验证命令**:
```bash
npx vitest run sprints/08170328-kernel-092d90db/tests/ground-truth-proposal-remote.test.js sprints/08170328-kernel-092d90db/tests/regression-run-7a8e5319-rn.test.js --reporter=basic
```
...
**验证命令**:
```bash
npx vitest run sprints/08170328-kernel-092d90db/tests/derive-observation-gate.test.js --reporter=basic
```
...
**验证命令**:
```bash
npx vitest run sprints/08170328-kernel-092d90db/tests/work-routing-base-repo-backfill.test.js --reporter=basic
```
...
npx vitest run sprints/08170328-kernel-092d90db/tests/ --reporter=basic 2>&1 | tee /tmp/e2e-sprint.log
