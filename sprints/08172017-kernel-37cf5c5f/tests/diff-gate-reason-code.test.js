/**
 * diff-gate reason_code 三类分流回归测试 —— sprint 08172017-kernel-37cf5c5f
 *
 ...
 *
 * 注：本文件是合同冻结测试，落 sprints/<sprint_dir>/tests/（kernel 采集冻结产物只认此路径）；
 * Generator 在实现阶段复制为永久回归测试到 packages/brain/src/impact-contract/__tests__/。
 */
...
describe('diff-gate reason_code 三类分流（08172017-kernel-37cf5c5f）', () => {
