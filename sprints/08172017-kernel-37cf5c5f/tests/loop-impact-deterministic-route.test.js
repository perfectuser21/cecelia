/**
 * loop/derive 确定性 impact 出口路由测试 —— sprint 08172017-kernel-37cf5c5f
 *
...
function evaluatorTriggerObs() {
  return obs({
    ...
    decisionLog: [{ hop: 1, action: 'spawn:generator', created_at: '2026-08-17T11:00:00Z' }],
  });
}

describe('确定性 impact 结论按 reason 走确定性出口（08172017-kernel-37cf5c5f）', () => {
