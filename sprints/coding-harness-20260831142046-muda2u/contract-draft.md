...
NODE
git diff --name-only 5c12d2af68e2b2e4b8dcaaa2c87e50efab743291...HEAD | grep -Ev '^(docs/current/attempt-run-bridge-guide\.md|sprints/coding-harness-20260831142046-muda2u/)' && { echo 'FAIL: 修改超出文档与合同产物范围'; exit 1; } || true
