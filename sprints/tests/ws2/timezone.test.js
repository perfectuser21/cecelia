...
describe('Workstream 2 — /timezone happy path [BEHAVIOR]', () => {
  it('GET /timezone?tz=Asia/Shanghai returns 200 with echoed tz and non-empty formatted', async () => {
  ...
  it('GET /timezone?tz=UTC returns 200 with echoed tz=UTC', async () => {
...
describe('Workstream 2 — /timezone error handling [BEHAVIOR]', () => {
  it('GET /timezone?tz=Not/AReal_Zone returns 400 with non-empty error string', async () => {
  ...
  it('GET /timezone without tz param returns 400 with non-empty error string', async () => {
  ...
  it('GET /timezone?tz= (empty string) returns 400 with non-empty error string', async () => {
  ...
  it('GET /timezone?tz=<sql-injection-like-garbage> returns 400 not 500', async () => {
