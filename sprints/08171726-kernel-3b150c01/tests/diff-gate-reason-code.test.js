/**
 * diff-gate reason_code 三类分流回归测试 —— sprint 08171726-kernel-3b150c01
 *
 ...
 *
 * 冻结产物：本文件由 Proposer 落在 sprints/<sprint_dir>/tests/（kernel 只从此目录采集冻结测试）；
 * Generator 实现阶段复制到 packages/brain/src/impact-contract/__tests__/ 作为永久回归。
 */
...
describe('diff-gate reason_code 三类分流（08171726-kernel-3b150c01）', () => {
