/**
 * harness-gates beforeEvaluate gateReceipt 透传测试 —— sprint 08171726-kernel-3b150c01
 *
 ...
 *
 * 冻结产物：Proposer 落 sprints/<sprint_dir>/tests/；Generator 复制到
 * packages/brain/src/impact-contract/__tests__/ 作为永久回归。被改的边（diff-gate→gateReceipt）真实执行，
 * 仅 mapper 结论用注入替身（diffGate 注入 blocked 结果，range 外）。
 */
...
describe('gateReceipt 透传 reason/retryable/detail（08171726-kernel-3b150c01）', () => {
