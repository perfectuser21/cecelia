...
- [x] [ARTIFACT] reportNode 源码含三字段（step_timing/ws_issues/ws_costs）
...
- [x] [ARTIFACT] reportNode 含 `report_content` 键写入 tasks.result
...
- [x] [ARTIFACT] 禁用字段不作为 reportContent JSONB 键出现（精确键名匹配）
