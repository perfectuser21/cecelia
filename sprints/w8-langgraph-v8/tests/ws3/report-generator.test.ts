 ...
 *   - 报告内不留 placeholder
 *
 * Generator 阶段会创建脚本和模板。Round 1 Red：脚本不存在 → 全 fail。
 */
...
describe('Workstream 3 — run-acceptance.sh shape [BEHAVIOR]', () => {
...
describe('Workstream 3 — generate-report.mjs DRY_RUN [BEHAVIOR]', () => {
...
describe('Workstream 3 — acceptance-report.template.md [BEHAVIOR]', () => {
