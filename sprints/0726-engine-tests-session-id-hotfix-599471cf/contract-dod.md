...
- [x] [BEHAVIOR] dry-run 输出含 --session-id UUID
  - Test File: `tests/regression/engine-tests-session-id-hotfix-599471cf/cecelia-run-session-id.test.ts`
  - Test: manual:bash -lc 'npx vitest run tests/regression/engine-tests-session-id-hotfix-599471cf/cecelia-run-session-id.test.ts --reporter=verbose'
...
- [x] [ARTIFACT] 合同测试在 `(Red)` commit 新增，且已纯 rename 入册到 `tests/regression/engine-tests-session-id-hotfix-599471cf/cecelia-run-session-id.test.ts`。
  - Test: manual:bash -lc 'test -f tests/regression/engine-tests-session-id-hotfix-599471cf/cecelia-run-session-id.test.ts'

- [x] [ARTIFACT] `scripts/smoke/e2e/engine-tests-session-id-hotfix-599471cf.sh` 已入册、可执行并真跑完整链路。
  - Test: manual:bash -lc 'test -x scripts/smoke/e2e/engine-tests-session-id-hotfix-599471cf.sh && bash scripts/smoke/e2e/engine-tests-session-id-hotfix-599471cf.sh'
