// 冻结合同测试（seal gate / runner finalizer 认这一份）—— 边：commander lease 过期有界自动重派 [r74]
//
// 背景（本主题第三次点火，r73/run da3aa553 案卷）：kernel 编排器 derive.js 的
...
// 与 tests/gp/f1/step3-commander-infra-retry-bounded.test.js 是同一改动的两个 CI 闸产物：
