...
|---|---|---|---|
| fire drill r3 交付文档 | `tests/fire-drill-doc.test.ts` | 验收命令通过：文件存在且含标记 KERNEL_V1_MIXED_FIRE_DRILL_PASS_R3、字面包含生产版本 1.267.67 与 merge commit 19887912bbb581597f12c714a9ed187f051e2850、六角色 provider/account 证据行齐全、证据锚定本次 run_id 4c7fcc5b-32ee-4a7f-9649-3b857ed30610 | → 4 failures（文件尚不存在，readFile ENOENT） |
