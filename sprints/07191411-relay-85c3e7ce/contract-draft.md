...
|---|---|---|---|
| S1 | `../../tests/regression/relay-85c3e7ce/contract-red.test.sh` | BEHAVIOR-01/BEHAVIOR-02/BEHAVIOR-03/BEHAVIOR-04/BEHAVIOR-05/BEHAVIOR-06 | exit 1（e2e-verify.sh 缺失时失败） |
