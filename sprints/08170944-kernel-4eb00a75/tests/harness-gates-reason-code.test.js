/**
 * harness-gates beforeEvaluate gateReceipt 透传测试 —— sprint 08170944-kernel-4eb00a75
 *
 ...
 *
 * 被改的边（harness-gates gateReceipt ↔ diff-gate 结果）真实执行：注入的 diffGate 返回一个
 * 与 evaluateDiffGate 确定性 blocked 输出同形的结果对象（radius/mapper 范围外），gateReceipt 透传本体真跑。
 */
...
describe('gateReceipt 透传 reason/retryable/detail（08170944-kernel-4eb00a75）', () => {
