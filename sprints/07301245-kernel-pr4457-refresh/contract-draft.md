...
**可观测行为**: `evidence/freeze.json` 精确记录两个 SHA、冲突清单、77 条 CodeQL 指纹和 required checks；计数或来源不符即失败。
**验证命令**:
```bash
node sprints/07301245-kernel-pr4457-refresh/scripts/verify-pr4457-evidence.mjs freeze
```
**硬阈值**: 起点 SHA=`8f2137d0f5ad7091699f42635ea76c35e0765bd9`、main SHA=`264482fadd87dc8bf6e7d4534c156ee28e276ccf`、冲突=32、CodeQL=77、所有条目 fingerprint 唯一；由上述命令非零退出执法。
