...
| **死亡告警（停了谁知道）** | 告警 | failure-stats 恒空 / 机械闸失效由 CI（brain-ci.yml lint 步 + 本合同回归 BEHAVIOR）在下次改动时暴露；运营侧 7 天窗口计量由后续日报消费（本 sprint 不含日报）。 |
