...
**范围**: 在 `docs/learnings/w8-langgraph-v17-e2e.md` 写一份 walking skeleton 实证文档（含 run_date / node_durations / gan_proposer_rounds / pr_url / 任务定位 / DoD 列表占位）。不修改任何运行时代码（packages/brain | packages/engine | packages/workflows 零变更）。
