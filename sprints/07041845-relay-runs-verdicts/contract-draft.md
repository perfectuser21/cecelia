...
|---|---|---|---|
| WS1 | `../../packages/brain/src/__tests__/relay-runs-verdicts.test.js` | 五个新字段同时存在,五字段全 null,不含 camelCase,colErr 回退路径,详情响应含 cost_usd | Red：7 fail / 18 pass（实现前列表 SQL 缺五字段，详情缺 cost_usd） |
