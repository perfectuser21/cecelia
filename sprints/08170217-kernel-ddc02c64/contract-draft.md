...
**验证命令**:
```bash
npx vitest run sprints/08170217-kernel-ddc02c64/tests/ground-truth-proposal-remote.test.js sprints/08170217-kernel-ddc02c64/tests/regression-run-7a8e5319-rn.test.js --reporter=basic
```
...
**验证命令**:
```bash
npx vitest run sprints/08170217-kernel-ddc02c64/tests/derive-observation-gate.test.js --reporter=basic
```
...
**验证命令**:
```bash
npx vitest run sprints/08170217-kernel-ddc02c64/tests/work-routing-base-repo-backfill.test.js --reporter=basic
```
...
npx vitest run sprints/08170217-kernel-ddc02c64/tests/ --reporter=basic 2>&1 | tee /tmp/e2e-sprint.log
