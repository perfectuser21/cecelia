...
- [ ] [ARTIFACT] harness-report SKILL.md 含 "Step 3.5" 字面量
  Test: grep -q "Step 3.5" packages/workflows/skills/harness-report/SKILL.md || exit 1

- [ ] [ARTIFACT] SKILL.md Step 3.5 映射中含 "SprintPRD"（不是 "PRD"）
  Test: grep -A30 "Step 3.5" packages/workflows/skills/harness-report/SKILL.md | grep -q "SprintPRD" || exit 1

- [ ] [ARTIFACT] SKILL.md Step 3.5 映射中含 "PrepPRD"
  Test: grep -A30 "Step 3.5" packages/workflows/skills/harness-report/SKILL.md | grep -q "PrepPRD" || exit 1
