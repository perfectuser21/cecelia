...
- [ ] [BEHAVIOR] [L2] B-08: failure-stats 响应 schema 完整性卡（五必填字段一个不缺）
  动作: GET localhost:5221/api/brain/harness/failure-stats?days=7
...
- [ ] [BEHAVIOR] [L2] B-09: 禁用字段反向断言（防 api_registry 同义字段漂移）
  动作: GET localhost:5221/api/brain/harness/failure-stats?days=7
...
- [ ] [BEHAVIOR] [L2] B-10: days 越界口径 clamp（0/负/超大值 → period_days ∈ [1,365]，补 PRD 边界情况）
