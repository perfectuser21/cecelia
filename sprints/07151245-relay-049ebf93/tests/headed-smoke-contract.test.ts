...
// Sprint: sprints/07151245-relay-049ebf93 — 锚定 task_id=049ebf93-fa61-4777-b619-5a44fcce296a 的
// headed relay 派发链路回归证据。结构镜像已毕业先例 scripts/smoke/e2e/relay-4bb31ef5.sh /
...
describe('headed smoke contract (task 049ebf93) [BEHAVIOR]', () => {
  ...
  it('payload 三元组齐全且禁用 token/github_token/anthropic_token/thin_prd', () => {
    const script = readWrapper();
    expect(script).toContain('049ebf93-fa61-4777-b619-5a44fcce296a');
