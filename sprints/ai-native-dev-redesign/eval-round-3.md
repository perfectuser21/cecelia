...
1. `sprints/ai-native-dev-redesign/` 目录在 main 上不存在（只有 eval-round-2.md 在未合并的 PR #2315 分支上）— 历史记录未回写 main，不影响功能
2. PR #2312 auto-merge job `auto-merge: SKIPPED` — 因为这些 PR 没有 harness 标签，符合预期
