...
- [ ] [BEHAVIOR] `contract-review-feedback.md` 三元组覆盖率 >= 草案命令数 * 60%，命令字段与草案 readFileSync 路径指纹匹配，至少 1 个 YES，判决格式为 `**判决**: X`
