...
- [ ] [BEHAVIOR] [L2] 服务端 task/run/PR 真相推导 target_environment 与 required contexts，caller 参数不得创建 authority
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/required-context-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "server-owned facts derive target_environment and required contexts" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] stale SHA、wrong repo、wrong run/task、missing context、external infra failure 各自独立返回稳定 reason
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/required-context-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "independent blocker reason stays exact" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] `local_api` 仅在当前 SHA 上全部本地 required contexts 通过时允许 preview neutral
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/required-context-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "local_api preview neutral only after local contexts pass" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] preview-dependent target 缺 preview 或 preview FAIL 时硬失败
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/required-context-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "preview-dependent targets hard fail without preview" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] preview failure 路径持久化 `http_status`、`response_body`、`error` 三字段且全部非空
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/preview-route-evidence.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "preview failure persists http status response body and error" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] preview success path 与 failure path 分离，不得以 failure evidence 冒充成功
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/preview-route-evidence.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "preview success path stays separate" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] generator-fix 必须通过 ground-truth→derive/gate→decision-log 在当前 SHA 上闭环证明
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/kernel-release-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "ground truth derive gate decision-log close the loop on current sha" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] post-merge 的 staging/production/final-report blocker 全部独立硬阻断
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/kernel-release-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "post-merge gate stays independent" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] Draft PR + `autoMergeRequest=null` 下旧 SHA approval 在新提交后失效
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/kernel-release-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "stale approval invalidated by new commit" --reporter=verbose'
  期望: exit 0
...
- [ ] [BEHAVIOR] [L2] INV-2 [SHA锚定] accepted checks / evaluator / judge / approval 全部锚定当前 head SHA
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/required-context-gate.contract.test.ts ../../sprints/07272237-kernel-226fda26/tests/kernel-release-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs -t "independent blocker reason stays exact|stale approval invalidated by new commit" --reporter=verbose'
...
- [ ] [BEHAVIOR] [L2] INV-6 [manual真跑] 合同测试通过真实 vitest 运行，不允许静态 grep 替代
  ...
  Test: manual:bash -lc 'cd packages/brain && npx vitest run ../../sprints/07272237-kernel-226fda26/tests/required-context-gate.contract.test.ts ../../sprints/07272237-kernel-226fda26/tests/preview-route-evidence.contract.test.ts ../../sprints/07272237-kernel-226fda26/tests/kernel-release-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs --reporter=verbose'
...
- [ ] [BEHAVIOR:E2E] Kernel required-context gate Red-first 合同测试在本地真实跑起
  ...
  Test: manual:bash -lc 'set +e; cd packages/brain; npx vitest run ../../sprints/07272237-kernel-226fda26/tests/required-context-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs --reporter=verbose; A=$?; npx vitest run ../../sprints/07272237-kernel-226fda26/tests/preview-route-evidence.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs --reporter=verbose; B=$?; npx vitest run ../../sprints/07272237-kernel-226fda26/tests/kernel-release-gate.contract.test.ts --config ../../sprints/07272237-kernel-226fda26/tests/vitest.contract.config.mjs --reporter=verbose; C=$?; set -e; [ "$A" -ne 0 ] || [ "$B" -ne 0 ] || [ "$C" -ne 0 ]'
