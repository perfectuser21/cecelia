...
容器 --rm 后明细全丢）。canonical Runner digest 重钉为 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`。
...
- canonical runner digest 重钉为 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`；11 处 pin 同步。
...
- canonical Runner digest 重钉为 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`（`docker/build.sh` 构建，label `cecelia.build.head=e1e2be0af`），11 处 pin 同步；Fleet Worker 版本 pin 不变。
...
- canonical Runner digest 重钉为 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`（`docker/build.sh` 构建，label `cecelia.build.head=65a6c3266`），11 处 pin 同步；Fleet Worker 版本 pin 不变。
...
- canonical Runner digest 重钉为 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`（`docker/build.sh` 构建，label `cecelia.build.head=87079e056`），11 处 pin 同步；Fleet Worker 版本 pin 不变。
...
- canonical Runner digest 重钉为 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`（`docker/build.sh` 构建，label `cecelia.build.head=e0b4a0c93`），11 处 pin 同步；Fleet Worker 版本 pin 不变。
...
- canonical Runner digest 重钉为 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`（`docker/build.sh` 构建，label `cecelia.build.head=fab5b118d`），NodeProfile / rollout / reconciler / installer / smoke 全部同步；Fleet Worker 版本 pin 不变。
...
- Canonical Runner 更新为从冻结源码与供应链标签重建并验证的 `sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3`；全部 Fleet pin 点保持一致。
