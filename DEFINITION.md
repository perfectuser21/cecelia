...
| **schema_version** | 迁移版本追踪 | Schema 版本: 208 |
...
| sprint_evaluate | US | Harness Sprint Evaluator（验证 Generator 产出） | Sonnet / - | 默认 anthropic |
| sprint_fix | US | Harness Sprint Fix（修复 Evaluator 发现的问题） | Sonnet / - | 默认 anthropic |
