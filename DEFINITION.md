...
- OKR：create_okr, update_okr_progress, assign_to_autumnrice, okr_initiative_completed, okr_scope_completed, okr_project_completed
...
| **schema_version** | 迁移版本追踪 | Schema 版本: 178 |
...
| okr_initiative_plan | 西安 | OKR Scope 下规划下一个 Initiative (/decomp) | Opus / - | 默认 anthropic |
| okr_scope_plan | 西安 | OKR Project 下规划下一个 Scope (/decomp) | Opus / - | 默认 anthropic |
| okr_project_plan | 西安 | OKR Project 层完成后规划下一步 (/decomp) | Opus / - | 默认 anthropic |
