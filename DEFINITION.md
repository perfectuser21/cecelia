...
| **schema_version** | 迁移版本追踪 | Schema 版本: 271 |
| **janitor_runs** | Janitor 任务执行记录（migration 271，job_name/status/output/duration） |
| **janitor_config** | Janitor 任务配置（migration 271，enabled/schedule/last_run） |
