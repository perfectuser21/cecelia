...
## Brain 1.268.33 — 输入边界加固

- 消除动态 shell、SSRF、外控格式字符串与多项式正则风险。

## Brain 1.268.32 — CodeQL 防护收敛

- 为 Brain 与运维路由补齐统一速率限制，并收紧 GitHub Actions 默认令牌权限。

**状态**: 生产运行中

---

## Brain 1.268.31 — Kernel atomic behavior equivalence gate
...
- Merge authority 同时强制 approved contract、exact diff/check/base、
