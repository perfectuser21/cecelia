/**
 * Contract Test Skeleton — PR1 对话会话基础层
 ...
 * - 测试文件为骨架，开发实现 conversations.js 路由后激活
 *
 * 说明：
 * - 此文件放在 sprints/ 目录作为合同参考，
 *   实际单测文件为 packages/brain/src/routes/__tests__/conversations.test.js
 */
...
async function createApp() {
  ...
  const { default: conversationsRouter } = await import(
    '../../../packages/brain/src/routes/conversations.js'
  );
