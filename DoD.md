...
- [x] [ARTIFACT] packages/brain/src/routes/harness.js 中 pipeline-detail 端点包含 system_prompt_content 字段读取逻辑
...
- [x] [BEHAVIOR] API 返回的每个 step 的 system_prompt_content 为 string（有 SKILL.md）或 null（无 SKILL.md），调用实际端点验证
