...
=======
# DoD: 蓝绿 green canary 三连失败根治——健康判据防幽灵代理 + smoke 就绪等待 + TEMP_PORT 挪 5230
...
>>>>>>> 1cea329ec (fix(deploy): 蓝绿 green canary 三连失败根治——健康判据防幽灵代理 + smoke 宿主就绪等待 + TEMP_PORT 5223→5230)
