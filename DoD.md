...
- [x] [BEHAVIOR] task-router.js VALID_TASK_TYPES 包含 4 个新 Gate 类型
...
- [x] [BEHAVIOR] task-router.js SKILL_WHITELIST 包含 4 个 Gate 路由
...
- [x] [BEHAVIOR] task-router.js LOCATION_MAP 包含 4 个 Gate 路由（均为 us）
...
- [x] [BEHAVIOR] executor.js skillMap 包含 4 个 Gate 类型
...
- [x] [BEHAVIOR] executor.js US_ONLY_TYPES 包含 4 个 Gate 类型
...
- [x] [BEHAVIOR] executor.js 新增 initiative_review 命令构建逻辑
...
- [x] [BEHAVIOR] decomposition-checker.js 删除 hasExistingInitiativePlanTask
...
- [x] [BEHAVIOR] decomposition-checker.js 删除 createInitiativePlanTask
...
- [x] [BEHAVIOR] decomposition-checker.js checkReadyKRInitiatives 不再创建 initiative_plan 任务
...
- [x] [BEHAVIOR] token-budget-planner.js EXECUTOR_AFFINITY 包含 4 个 Gate 类型
...
- [x] [BEHAVIOR] pre-flight-check.js SYSTEM_TASK_TYPES 包含 4 个 Gate 类型
...
- [x] [BEHAVIOR] planner.js Area Stream 保留并加注释说明独立用途
