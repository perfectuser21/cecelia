...
- [x] [ARTIFACT] `playground/server.js` 注册 GET `/kernel-ping2`，且 `playground/tests/server.test.js` 永久包含对应回归用例。
...
- [x] [BEHAVIOR] [L2] B-01: GET `/kernel-ping2` 返回严格 200 与 `ok2`
...
- [x] [BEHAVIOR] [L2] B-02: 成功响应仅含 `result` 字段
...
- [x] [BEHAVIOR] [L2] B-03: 非 GET 方法不冒充成功
...
- [x] [BEHAVIOR] [L2] B-04: 既有 health 端点不回退
