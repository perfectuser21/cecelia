...
- [x] [BEHAVIOR] SKILL Step 3 git push 失败时整体 exit=0 且 stdout 含 fallback
  Test: tests/skills/harness-planner-push-noise.test.js

- [x] [BEHAVIOR] SKILL Step 3 git push 成功时不打 fallback echo（无噪音）
  Test: tests/skills/harness-planner-push-noise.test.js

- [x] [ARTIFACT] SKILL.md:151 含 2>/dev/null + || echo + push skipped
