-- Migration 142: Add retry_count to tasks table
...
-- Schema version
INSERT INTO schema_version (version, description) VALUES ('142', 'Add retry_count to tasks table for timeout requeue logic');
