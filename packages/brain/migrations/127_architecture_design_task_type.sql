-- Migration 127: 扩展 tasks_task_type_check — 加入 architecture_design
-- planner.js 的 generateArchitectureDesignTask 使用 task_type='architecture_design'
-- executor.js 的 skillMap 已有 architecture_design → /architect 路由
