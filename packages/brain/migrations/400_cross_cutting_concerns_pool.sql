...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    VALUES ('Brain Tick 调度引擎', 'enabler', 'active', v_factory_id, 'cross-cutting');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO journey_features (name, kind, status, journey_id, "group")
    VALUES ('DevGate 门禁系统', 'enabler', 'active', v_factory_id, 'cross-cutting');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO journey_features (name, kind, status, journey_id, "group")
    VALUES ('Harness Relay 执行链路', 'enabler', 'active', v_factory_id, 'cross-cutting');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO journey_features (name, kind, status, journey_id, "group")
    VALUES ('凭据管理与安全', 'enabler', 'active', v_factory_id, 'cross-cutting');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO journey_features (name, kind, status, journey_id, "group")
    VALUES ('CI/CD 流水线', 'enabler', 'active', v_factory_id, 'cross-cutting');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO journey_features (name, kind, status, journey_id, "group")
    VALUES ('告警与 Bark 推送', 'enabler', 'active', v_factory_id, 'cross-cutting');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO journey_features (name, kind, status, journey_id, "group")
    VALUES ('Memory 语义搜索', 'enabler', 'active', v_factory_id, 'cross-cutting');
  END IF;
