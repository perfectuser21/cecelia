-- Migration 419: initiative_runs Session Controller 所有权列（Harness 入口统一 sprint 08131104）
--
-- 413—418 已由 Unified Work Router / Map / contract governance 使用，因此 Controller
-- ownership 在合并时顺延到 419，确保迁移版本仍是一号一义。
...
VALUES ('419', 'initiative_runs Session Controller ownership (controller_session_id + controller_lease_expires_at)', NOW())
