-- Migration 362: reconcile provider-neutral Kernel attempt telemetry.
--
-- Production already owns schema_version 361 for Codex slot machine mappings.
-- Replaying the additive DDL under a distinct version makes the telemetry
-- columns converge on both legacy production databases and fresh databases.
...
VALUES ('362', 'Reconcile Kernel attempt lineage and telemetry fields', NOW())
