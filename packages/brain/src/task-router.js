 ...
 * 5. Domain-aware skill routing via getDomainSkillOverride and getInitiativeSkill
 */
...
function routeTaskCreate(taskData) {
  ...
  // initiative_plan uses getInitiativeSkill (coding→/architect, others→role skill, fallback→/decomp)
  // other types use getDomainSkillOverride (coding→null/default, others→role skill)
