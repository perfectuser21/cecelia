...
const SKILL_WHITELIST = {
  ...
  // OKR 新表飞轮（okr_projects→okr_scopes→okr_initiatives）
  'okr_initiative_plan': '/decomp',  // OKR Initiative 内规划下一个 Task
  'okr_scope_plan': '/decomp',       // OKR Scope 内规划下一个 Initiative
  'okr_project_plan': '/decomp',     // OKR Project 内规划下一个 Scope
};
...
const LOCATION_MAP = {
  ...
  // OKR 新表飞轮
  'okr_initiative_plan': 'xian',   // OKR Initiative 规划 → 西安 Codex (/decomp)
  'okr_scope_plan': 'xian',        // OKR Scope 规划 → 西安 Codex (/decomp)
  'okr_project_plan': 'xian',      // OKR Project 规划 → 西安 Codex (/decomp)
