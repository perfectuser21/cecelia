...
export async function preFlightCheck(task) {
  ...
  const SYSTEM_TASK_TYPES = ['dept_heartbeat', 'codex_qa', 'codex_playwright', 'initiative_verify', 'initiative_plan', 'code_review', 'prd_review', 'spec_review', 'code_review_gate', 'initiative_review'];
