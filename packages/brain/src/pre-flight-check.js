...
export async function preFlightCheck(task) {
  ...
  const SYSTEM_TASK_TYPES = ['dept_heartbeat', 'codex_qa', 'initiative_verify', 'initiative_plan', 'code_review', 'prd_review', 'spec_review', 'code_review_gate', 'initiative_review',
    ...
    // Sprint Harness tasks — auto-generated by execution callback chain, no separate PRD needed
    'sprint_planner', 'sprint_contract_propose', 'sprint_contract_review',
    'sprint_generate', 'sprint_fix', 'sprint_evaluate', 'sprint_report',
    // Harness pipeline tasks — auto-generated by Brain harness orchestrator, no separate PRD needed
    'harness_contract_propose', 'harness_contract_review', 'harness_generate',
    'harness_evaluate', 'harness_report', 'harness_planner'];
