...
| 意图类型 | task_type | 说明 |
|---------|-----------|------|
| coding / dev / 编程 | dev | 编程任务、功能开发、bug修复 |
| research / explore / 调研 | research | 调研、分析、查找信息 |
| remember / note / 记录 | research | 记录想法、保存认知 |
| automate / n8n / 自动化 | dev | 自动化流程、工作流 |
| kr_replan / strategy / 战略 | initiative_plan | KR重规划、战略调整 |
| okr / goals / OKR拆解 | initiative_plan | OKR拆解、目标设定 |
| 其他 / 不明确 | dev | 默认路由 |
