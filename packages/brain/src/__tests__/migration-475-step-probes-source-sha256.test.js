/**
 * 迁移 475 结构断言（链 bf5088a3 棒2 后续）：step_probes 加 source_sha256——探针文件整文件哈希
...
const up = fileURLToPath(new URL('../../migrations/475_step_probes_source_sha256.sql', import.meta.url));
const down = fileURLToPath(new URL('../../migrations/rollback/475_step_probes_source_sha256.down.sql', import.meta.url));
