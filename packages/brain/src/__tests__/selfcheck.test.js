...
describe('selfcheck', () => {
  ...
  // 424—430（Attempt cleanup / Map validation / recovery receipt-to-run authority）。
  it('EXPECTED_SCHEMA_VERSION should be 430', () => {
    expect(EXPECTED_SCHEMA_VERSION).toBe('430');
  });
