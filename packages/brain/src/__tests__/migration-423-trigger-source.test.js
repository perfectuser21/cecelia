...
const migration = new URL('../../migrations/424_tasks_trigger_source_text.sql', import.meta.url);
const rollback = new URL('../../migrations/rollback/424_tasks_trigger_source_text.down.sql', import.meta.url);

describe('migration 424: tasks.trigger_source no longer truncates routed provenance', () => {
  it('widens trigger_source to text without rewriting values', () => {
    ...
    expect(sql).toMatch(/INSERT INTO schema_version[\s\S]*['"]424['"]/i);
