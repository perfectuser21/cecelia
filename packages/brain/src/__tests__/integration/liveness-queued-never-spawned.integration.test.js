/**
 * liveness-queued-never-spawned.integration.test.js [BEHAVIOR]
 *
 ...
 *
 * 毕业自 sprints/08071002-relay-94ee0ec4/tests/liveness-queued-never-spawned.integration.test.ts，
 * 已登记 vitest.config.js POSTGRES_INTEGRATION_TESTS，永久回归入 CI（brain-integration job）。
