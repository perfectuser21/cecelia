...
//   executor.js:2330 的 task_type→handler 函数路由表 _TASK_ROUTES，函数值无法进纯数据注册表）
...
export const REMAINING_LEGACY_SITES = {
  // kind: map（long-lived）— 唯一残留 :2330 _TASK_ROUTES（task_type→handler 函数，无法表示为注册表纯数据字段）
  'executor.js': ['2330:_TASK_ROUTES'],
