...
export const JOBS = [
  ...
  { name: 'notion-capture-ingest', needsPool: true, timeoutMs: DEFAULT_TIMEOUT_MS, handler: runNotionCaptureIngest, description: 'Notion 个人 Inbox 增量采集（5min自gate，last_edited_time游标，双token幂等，F6加厚 WS2，凭据CCAPI2026）' },
];
