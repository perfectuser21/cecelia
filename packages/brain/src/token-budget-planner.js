...
const EXECUTOR_AFFINITY = {
  ...
  'sprint_planner':           { primary: 'claude', fallback: null, no_downgrade: true },
  'sprint_contract_propose':  { primary: 'claude', fallback: null, no_downgrade: true },
  'sprint_contract_review':   { primary: 'claude', fallback: null, no_downgrade: true },
  'sprint_generate':          { primary: 'claude', fallback: null, no_downgrade: true },
  'sprint_evaluate':          { primary: 'claude', fallback: null, no_downgrade: true },
  'sprint_fix':               { primary: 'claude', fallback: null, no_downgrade: true },
  ...
  // 始终走 Codex（不消耗 Claude，MiniMax 已停用）
  ...
  'content_publish':      { primary: 'codex',   fallback: null,     no_downgrade: true  },
};
