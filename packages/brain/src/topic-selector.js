...
// 只使用已在 DB 中配置 notebook_id 的内容类型，避免 content-research 阶段立即失败。
// 待 ai-tools-review / ai-workflow-guide 配置好 notebook_id 后，将其加回此列表。
const AVAILABLE_CONTENT_TYPES = ['solo-company-case'];
