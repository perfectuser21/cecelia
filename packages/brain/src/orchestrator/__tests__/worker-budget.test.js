...
// __dirname = .../packages/brain/src/orchestrator/__tests__
// 向上5级到达 workspace root
const WORKSPACE_ROOT = join(__dirname, '../../../../..');

import { ROLE_BUDGET_SECS } from '../constants.js';
import { computeWorkerDeadlineSecs } from '../gates.js';
