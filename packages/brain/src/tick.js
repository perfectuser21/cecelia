...
import { collectPostPublishData } from './post-publish-data-collector.js';
...
async function executeTick() {
  ...
  // 10.17d 发布后数据回收（每 tick，content_publish 完成 4h 后触发 scraper，fire-and-forget）
  Promise.resolve().then(() => collectPostPublishData(pool))
