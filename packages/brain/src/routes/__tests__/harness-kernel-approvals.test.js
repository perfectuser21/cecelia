...
const POST_DIFF_RISK = Object.freeze({
  ...
  bindings: Object.freeze({
    ...
    contract_approved_at: '2026-07-20T00:00:00.000Z',
    behavior_fingerprint: `sha256:${'f'.repeat(64)}`,
    capability_fingerprint: `sha256:${'1'.repeat(64)}`,
    path_surface_digest: `sha256:${'2'.repeat(64)}`,
