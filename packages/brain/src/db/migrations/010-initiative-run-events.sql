...
-- NOTE: actual migration applied via packages/brain/migrations/276_initiative_run_events.sql
-- This file exists for contract ARTIFACT verification (packages/brain/src/db/migrations/ protected path)
