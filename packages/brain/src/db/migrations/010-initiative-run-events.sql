...
CREATE TABLE initiative_run_events (
  ...
  node        TEXT        NOT NULL
    CHECK (node IN ('proposer', 'reviewer', 'planner', 'generator', 'evaluator', 'reporter')),
...
CREATE INDEX IF NOT EXISTS idx_ire_initiative_created ON initiative_run_events (initiative_id, created_at);
