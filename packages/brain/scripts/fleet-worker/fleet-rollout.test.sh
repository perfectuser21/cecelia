...
expected_runner_digest='sha256:720c9c7bf02826301bd9b89246c20bc276e3c2b1d5b1991feb00b582832a7288'
...
grep -Eq 'docker save --output .* sha256:720c9c7bf02826301bd9b89246c20bc276e3c2b1d5b1991feb00b582832a7288 pgvector/pgvector:pg15$' "$artifact_log" \
