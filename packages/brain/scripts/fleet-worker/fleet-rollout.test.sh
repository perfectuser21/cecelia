...
expected_runner_digest='sha256:e0797f5a440d61827d1ea86afee629e6f5a687da6f958608671ba9c873e5e94a'
...
grep -Eq 'docker save --output .* sha256:e0797f5a440d61827d1ea86afee629e6f5a687da6f958608671ba9c873e5e94a postgres:16-alpine$' "$artifact_log" \
