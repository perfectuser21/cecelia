...
expected_runner_digest='sha256:33a8195883be13252dbb4a2a355e0ee90f7ae89ff6846cde5d898a4bc515561b'
...
grep -Eq 'docker save --output .* sha256:33a8195883be13252dbb4a2a355e0ee90f7ae89ff6846cde5d898a4bc515561b pgvector/pgvector:pg15$' "$artifact_log" \
