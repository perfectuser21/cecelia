...
expected_runner_digest='sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3'
...
grep -Eq 'docker save --output .* sha256:fe2fa34532122dc936b770bdc6042f3618459ab168d0d9db2fde03ef181169f3 pgvector/pgvector:pg15$' "$artifact_log" \
