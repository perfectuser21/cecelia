...
expected_runner_digest='sha256:65763fdcfb70340e1ac8eeb21cd4d1aedf6edcee8e8978e6f59b085ca5f6cc75'
...
grep -Eq 'docker save --output .* sha256:65763fdcfb70340e1ac8eeb21cd4d1aedf6edcee8e8978e6f59b085ca5f6cc75 pgvector/pgvector:pg15$' "$artifact_log" \
