...
expected_runner_digest='sha256:eda14cf3706a9072422219c8bd7f169a0cffb0e77899917cd5a0b2acee5aa9a5'
...
grep -Eq 'docker save --output .* sha256:eda14cf3706a9072422219c8bd7f169a0cffb0e77899917cd5a0b2acee5aa9a5 pgvector/pgvector:pg15$' "$artifact_log" \
