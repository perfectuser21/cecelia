...
expected_runner_digest='sha256:bec4e67c1f91b6c0434c4ea49d079ef01f101a02aa03b45856b5e0e8e98b802f'
...
grep -Eq 'docker save --output .* sha256:bec4e67c1f91b6c0434c4ea49d079ef01f101a02aa03b45856b5e0e8e98b802f pgvector/pgvector:pg15$' "$artifact_log" \
