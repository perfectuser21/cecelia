...
expected_runner_digest='sha256:065bc4ecab7ef582e2fd844af5e3761ab2d430380bd0d0714cb201f319d341ea'
...
grep -Eq 'docker save --output .* sha256:065bc4ecab7ef582e2fd844af5e3761ab2d430380bd0d0714cb201f319d341ea pgvector/pgvector:pg15$' "$artifact_log" \
