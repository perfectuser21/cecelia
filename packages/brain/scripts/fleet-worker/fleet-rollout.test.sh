...
expected_runner_digest='sha256:d9087a85a3bbaa668628dfb3166f980a62c3851c8033d5d26e194fc975b55d0a'
...
grep -Eq 'docker save --output .* sha256:d9087a85a3bbaa668628dfb3166f980a62c3851c8033d5d26e194fc975b55d0a pgvector/pgvector:pg15$' "$artifact_log" \
