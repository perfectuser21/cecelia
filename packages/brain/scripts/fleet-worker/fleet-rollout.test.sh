...
expected_runner_digest='sha256:5b304402ac167aa6bac4011f6e66ad2dbf8106473a5bb4e32e40498620cfb31d'
...
grep -Eq 'docker save --output .* sha256:5b304402ac167aa6bac4011f6e66ad2dbf8106473a5bb4e32e40498620cfb31d postgres:16-alpine$' "$artifact_log" \
