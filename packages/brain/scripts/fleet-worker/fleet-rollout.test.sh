...
expected_runner_digest='sha256:4450aac9d8710bd02b37ec1f5e46ef06ab2e1ae108f453c3d25f85318af5be8e'
...
grep -Eq 'docker save --output .* sha256:4450aac9d8710bd02b37ec1f5e46ef06ab2e1ae108f453c3d25f85318af5be8e pgvector/pgvector:pg15$' "$artifact_log" \
