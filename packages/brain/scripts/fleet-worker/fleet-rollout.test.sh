...
expected_runner_digest='sha256:5fa1b7badc19a9cc1a806777d17023092e51d74330612143798d9ac7228693cc'
...
grep -Eq 'docker save --output .* sha256:5fa1b7badc19a9cc1a806777d17023092e51d74330612143798d9ac7228693cc pgvector/pgvector:pg15$' "$artifact_log" \
