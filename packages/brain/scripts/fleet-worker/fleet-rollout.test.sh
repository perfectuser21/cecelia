...
expected_runner_digest='sha256:bd9f49cade888003e29558137c32a9c2f95867052d8418dc161dafd8a7833edb'
...
grep -Eq 'docker save --output .* sha256:bd9f49cade888003e29558137c32a9c2f95867052d8418dc161dafd8a7833edb pgvector/pgvector:pg15$' "$artifact_log" \
