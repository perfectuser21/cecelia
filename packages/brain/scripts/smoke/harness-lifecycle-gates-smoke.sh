...
for (const f of ['packages/brain/src/callback-processor.js','packages/brain/src/routes/tasks.js','packages/brain/src/routes/task-tasks.js','packages/brain/src/routes/harness.js']) {
