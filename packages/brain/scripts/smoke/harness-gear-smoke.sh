...
RELAY_PATH="$REPO_ROOT/packages/brain/src/harness-skill-relay.js"

node --input-type=module <<JS
import { deriveGear, GEAR_VALUES } from '$RELAY_PATH';
...
node --input-type=module <<JS
import { GEAR_VALUES, deriveGear } from '$RELAY_PATH';
...
EXEC_PATH="$REPO_ROOT/packages/brain/src/executor.js"
...
CTRL_PATH="$REPO_ROOT/packages/workflows/skills/harness-controller/SKILL.md"
...
PROP_PATH="$REPO_ROOT/packages/workflows/skills/harness-contract-proposer/SKILL.md"
...
GEN_PATH="$REPO_ROOT/packages/workflows/skills/harness-generator/SKILL.md"
...
EVAL_PATH="$REPO_ROOT/packages/workflows/skills/harness-evaluator/SKILL.md"
