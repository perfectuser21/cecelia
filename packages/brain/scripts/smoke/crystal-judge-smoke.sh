...
# 验证：
#   1. migration 433 建齐四表（crystal_ledger/verdict/report/locator_registry）
...
echo "[crystal-smoke] 1. migration 433 建齐四表"
node -e "
const fs = require('fs');
const sql = fs.readFileSync('packages/brain/migrations/433_crystal_judge.sql', 'utf8');
...
console.log('migration 433 四表 + 复合键约束齐全 ✓');
"
