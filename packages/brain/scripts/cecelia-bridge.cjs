      ...
      try {
        ...
        child.on('close', (code) => {
          ...
          if (code !== 0) {
            ...
            safeRespond(res, 500, { ok: false, error: errMsg, retryable, elapsed_ms: elapsed });
            return;
          }
        ...
        child.on('error', (err) => {
          ...
          safeRespond(res, 500, { ok: false, error: err.message, retryable: false, elapsed_ms: elapsed });
        });
      } catch (err) {
