...
- runner assertion-exec 以断言文件最近的 package.json 目录为 cwd 跑 vitest（根 vitest include 不含 packages/*/src），required assertion 不再恒报 No test files found；canonical Runner digest 重钉为 `sha256:dbaa6b8c619da145aff93d31b226139bede9256eef6bd3e4c15733f9cbe95cf9`。
...
- canonical Runner digest 重钉为 `sha256:dbaa6b8c619da145aff93d31b226139bede9256eef6bd3e4c15733f9cbe95cf9`，Fleet Worker 版本 pin 不变。
...
- Canonical Runner 更新为冻结来源重建的 `sha256:dbaa6b8c619da145aff93d31b226139bede9256eef6bd3e4c15733f9cbe95cf9`，NodeProfile、rollout、reconciler 与 smoke 共享同一不可变 pin。
