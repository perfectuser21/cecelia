...
- `gh auth login` 在线校验不可用时回落直接写 hosts.yml（空 token 仍拒）；canonical Runner digest 重钉为 `sha256:65763fdcfb70340e1ac8eeb21cd4d1aedf6edcee8e8978e6f59b085ca5f6cc75`。
...
- 冻结候选树断言拒绝时打印漂移文件清单（路径/状态/模式，无内容）；canonical Runner digest 重钉为 `sha256:65763fdcfb70340e1ac8eeb21cd4d1aedf6edcee8e8978e6f59b085ca5f6cc75`。
...
- 断言所在包根目录补 a+w,+t 供 vite 写临时 bundled 配置；vitest 加 --no-cache；canonical Runner digest 重钉为 `sha256:65763fdcfb70340e1ac8eeb21cd4d1aedf6edcee8e8978e6f59b085ca5f6cc75`。

## 可信断言执行器按包根跑 vitest（Brain 1.273.65）

- runner assertion-exec 以断言文件最近的 package.json 目录为 cwd 跑 vitest（根 vitest include 不含 packages/*/src），required assertion 不再恒报 No test files found；canonical Runner digest 重钉为 `sha256:65763fdcfb70340e1ac8eeb21cd4d1aedf6edcee8e8978e6f59b085ca5f6cc75`。
...
- canonical Runner digest 重钉为 `sha256:65763fdcfb70340e1ac8eeb21cd4d1aedf6edcee8e8978e6f59b085ca5f6cc75`，Fleet Worker 版本 pin 不变。
