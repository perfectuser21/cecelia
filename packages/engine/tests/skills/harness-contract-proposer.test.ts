...
const SKILL_PATH = join(os.homedir(), '.claude', 'skills', 'harness-contract-proposer', 'SKILL.md');
...
describe('harness-contract-proposer 结构', () => {
  ...
  it.skipIf(!skillExists)('frontmatter version 跟随 skill 主版本（当前 7.x）', () => {
  ...
  it.skipIf(!skillExists)('职责章节包含 3 份产物描述', () => {
  ...
  it.skipIf(!skillExists)('contract-dod-ws 规则明确禁止 [BEHAVIOR] 条目', () => {
