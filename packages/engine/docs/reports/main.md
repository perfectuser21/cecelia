...
| 指标 | 状态 |
|------|------|
| CI 统计 | 总计 20 次 | 通过 17 次 | 失败 3 次 |
| Stage 1 Spec | ⏳ unknown |
| Stage 2 Code | ⏳ unknown |
| Stage 3 Integrate | ⏳ unknown |
| Stage 4 Ship | ⏳ unknown |
...
| CI 健康度 | 一次通过 → 10/10，每失败 -2 | 4/10 |
| 留痕完整度 | Seal 文件数量（5个=满分） | 0/10 |
| **总分** | [FULL] | **4/40** |
