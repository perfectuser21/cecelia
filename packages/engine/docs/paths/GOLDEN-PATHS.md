...
changelog:
  - 3.93.0: 从 feature-registry.yml 自动生成
---
...
## GP-046: CI Gate — 新增 hook/devgate 文件必须有 RCI 条目 (ci-gate-new-files-need-rci)

**Feature**: ci-gate-new-files-need-rci - CI Gate — 新增 hook/devgate 文件必须有 RCI 条目
**Priority**: P1
