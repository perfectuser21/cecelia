...
## GP-046: /dev subagent gates 补全 SKILL.md prompt 内联传入 (dev-subagent-skill-prompt-inline)

**Feature**: dev-subagent-skill-prompt-inline - /dev subagent gates 补全 SKILL.md prompt 内联传入
**Priority**: P1
...
## GP-047: DevGate CI 检查新增 task_type 对应 SKILL.md 存在性 (check-skill-file-exists)

**Feature**: check-skill-file-exists - DevGate CI 检查新增 task_type 对应 SKILL.md 存在性
**Priority**: P2
