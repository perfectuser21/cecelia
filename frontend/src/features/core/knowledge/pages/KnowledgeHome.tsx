import { BookOpen, PenTool, Brain, FileText, BookMarked } from 'lucide-react';
...
const sections = [
  ...
  { id: 'instruction-book', label: 'Instruction Book', icon: BookMarked, path: '/knowledge/instruction-book', desc: 'Skills & features manual' },
] as const;
