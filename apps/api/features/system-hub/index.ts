...
const manifest: FeatureManifest = {
  ...
  routes: [
    ...
    { path: '/harness/:id', component: 'HarnessStreamPage' },
    ...
    { path: '/settings/brain', component: 'SettingsLayout' },
    { path: '/settings/maintenance', component: 'SettingsLayout' },
    { path: '/settings/notifications', component: 'SettingsLayout' },
    { path: '/settings/accounts', component: 'SettingsLayout' },
  ...
  components: {
    ...
    SettingsPage: () => import('../../../dashboard/src/pages/settings/SettingsPage'),
    SettingsLayout: () => import('../../../dashboard/src/pages/settings/SettingsLayout'),
