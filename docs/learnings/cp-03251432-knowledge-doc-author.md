...
- migration编号冲突：189/190/191已被占用，需要使用192/193/194，spec编写时用了错误的编号
...
**migration 192**（author/made_by字段）：
