...
| 架构审查结果 | `docs/arch-reviews/YYYY-MM-DD.md` | 最新：2026-08-14 04:00 UTC，CRITICAL（12 高/18 中；当前 review 已恢复单执行，但 run-id/heartbeat/CRITICAL callback 仍无权威终态；staging hard-off 继续运行 Promotion，DB_HOST 与持久化源漂移，schema parity、Controller lease、调度测试与 nightly/release 仍未闭合） |
