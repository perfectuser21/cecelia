...
- [ ] [BEHAVIOR] verifyProposerOutput 5 个 case（happy / branch missing / task-plan missing / invalid JSON / empty tasks）PASS
  Test: tests/brain/h15-contract-verify.test.js

- [ ] [BEHAVIOR] verifyGeneratorOutput 3 个 case（happy / pr_url null / pr_not_found）PASS
  Test: tests/brain/h15-contract-verify.test.js

- [ ] [BEHAVIOR] verifyEvaluatorWorktree 3 个 case（happy / 1 missing / 多 missing）PASS
  Test: tests/brain/h15-contract-verify.test.js

- [ ] [BEHAVIOR] ContractViolation extends Error + name='ContractViolation' + details 对象
  Test: tests/brain/h15-contract-verify.test.js
...
- [ ] [ARTIFACT] 测试文件 tests/brain/h15-contract-verify.test.js 存在
