...
- [ ] [ARTIFACT] `.github/workflows/brain-ci-deploy.yml` 文件存在
...
- [ ] [BEHAVIOR] workflow 使用 push trigger + brain paths
...
- [ ] [BEHAVIOR] concurrency group 为 brain-autodeploy，与 deploy-production 隔离
...
- [ ] [BEHAVIOR] Gate 2 失败时创建 Brain P0 任务
