...
- [x] [BEHAVIOR] spawnNode contractBranch 存在时 import sprints/（git fetch + checkout + add + commit）
  Test: tests/brain/h13-import-contract-artifacts.test.js

- [x] [BEHAVIOR] spawnNode contractBranch null 时不 import
  Test: tests/brain/h13-import-contract-artifacts.test.js

- [x] [BEHAVIOR] spawnNode contractImported=true 时短路（幂等门）
  Test: tests/brain/h13-import-contract-artifacts.test.js

- [x] [BEHAVIOR] spawnNode import 失败 return error
  Test: tests/brain/h13-import-contract-artifacts.test.js

- [x] [ARTIFACT] harness-task.graph.js spawnNode 函数体含 'fetch' + 'checkout' + 'sprints/' + 'import contract' 字面量
...
- [x] [ARTIFACT] sub-graph state schema 含 contractImported field
