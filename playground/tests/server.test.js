...
describe('GET /decrement — happy + schema 完整性 [BEHAVIOR]', () => {
...
describe('GET /decrement — off-by-one 零边界 [BEHAVIOR]', () => {
...
describe('GET /decrement — 精度上下界拒 [BEHAVIOR]', () => {
...
describe('GET /decrement — 缺参 / 错 query 名 / query 唯一性 [BEHAVIOR]', () => {
...
describe('GET /decrement — 禁用字段反向（PR-G 死规则继承）[BEHAVIOR]', () => {
  const BANNED = [
...
describe('GET /decrement — 错误体 schema 完整性 [BEHAVIOR]', () => {
