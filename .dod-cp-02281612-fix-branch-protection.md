...
- [x] setup-branch-protection.sh 覆盖 perfectuser21/cecelia
      Test: manual:bash -c "grep -q 'perfectuser21/cecelia' packages/engine/scripts/setup-branch-protection.sh"
...
- [x] Engine tests 通过
      Test: manual:bash -c "cd packages/engine && npm test 2>&1 | grep -q 'passed'"
